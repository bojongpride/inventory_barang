<html>
    ...
    <body>
        ...
        <div class="container">
        <form class="mt30" action="submit_hapus_barang.php" method="post" id="form_pakai_barang">
        ...
        <input type="text" id="harga_beli" name="harga_beli" disabled>
    ...
    document.getElementById('search_button').addEventListener('click', function() {
        ...
        xhr.open('GET', 'data_hapus_barang.php?id_barang=' + id_barang, true);
        xhr.onload = function() {
            if (xhr.status === 200) {
    ...
    document.getElementById('submit').addEventListener('click', function() {
        var id_barang = document.getElementById('id_barang').value;
        var xhr = new XMLHttpRequest();
        xhr.open('POST', 'submit_hapus_barang.php', true); // File PHP yang akan menangani penghapusan barang
